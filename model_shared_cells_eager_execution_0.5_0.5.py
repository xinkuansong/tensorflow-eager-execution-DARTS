...
def main(debugging_process):

    # Construct keras model
    train_ratio = 0.5
    (x_train, y_train), (x_val, y_val) = parse_datasets_ratio(debugging_process, train_ratio)
    n_cells = 8
    num_classes = 10
    ...
    with tf.device(device):
        ...
        for epoch in range(num_epochs):
                train_arch_weights(model, train_dataset, val_dataset, architect, alphas_optimizer, weights_optimizer,
